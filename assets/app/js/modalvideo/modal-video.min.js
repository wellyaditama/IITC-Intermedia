...
!function(e){
    ...
    return function(){
        function e(t,n,o){
            function i(l,a){
                if(!n[l]){
                    ...
                    t[l][0].call(s.exports,function(e){
                        var n=t[l][1][e];
                        return i(n||e)
                    },s,s.exports,e,t,n,o)}return n[l].exports
                }
            ...
            try{var o=new window.CustomEvent("test");
            ...
            "use strict";function o(e,t){
                ...
                for(var n=Object(e),o=1;o<arguments.length;o++){
                    ...
                    for(var r=Object.keys(Object(i)),l=0,a=r.length;l<a;l++){
                        var u=r[l],d=Object.getOwnPropertyDescriptor(i,u);
                    ...
                    [].forEach.call(d,function(e){
                        e.addEventListener("click",function(){
                            ...
                            d.addEventListener("click",function(){
                                (0,r.addClass)(d,c.modalVideoClose),
                                setTimeout(function(){
                                    (0,r.remove)(d),e.focus()
                                },f)
                            }),d.addEventListener("keydown",function(e){
                                9===e.which&&(e.preventDefault(),
                                document.activeElement===d?v.focus():(d.setAttribute("aria-label",""),
                                d.focus()))
    ...
    5:[
        function(e,t,n){
            ...
            n.append=function(e,t){
                ...
                var o=void 0;window.CustomEvent?o=new CustomEvent(t,{
                    cancelable:!0
